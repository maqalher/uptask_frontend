import { deleteProjet, getProjects } from "@/api/PorjectApi";
...
export default function DashboardView() {
  ...
  const { data: user, isError: authLoading } = useAuth()
  ...
  if(isLoading && authLoading) return 'Cargando...' // ambas terminen de cargar
    
  if(data && user) return (
    <>
      <h1 className="text-5xl font-black">Mis Proyectos</h1> 
      <p className="text-2xl font-light text-gray-500 mt-5">Maneja y adminitra tus proyectos</p>
